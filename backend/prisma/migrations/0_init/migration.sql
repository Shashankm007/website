...
-- CreateEnum
CREATE TYPE "CustomizationType" AS ENUM ('NONE', 'STL_UPLOAD', 'PHOTO_UPLOAD');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PRINTING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');
...
-- CreateEnum
CREATE TYPE "InventoryReason" AS ENUM ('RESTOCK', 'ORDER', 'CANCELLATION', 'ADJUSTMENT', 'RETURN');
...
CREATE TABLE "products" (
    ...
    "fulfillment" "FulfillmentType" NOT NULL DEFAULT 'STOCKED',
    "customizationType" "CustomizationType" NOT NULL DEFAULT 'NONE',
...
-- CreateIndex
CREATE UNIQUE INDEX "cart_items_cartId_productId_variantId_customText_key" ON "cart_items"("cartId", "productId", "variantId", "customText");
...
-- CreateIndex
CREATE INDEX "custom_uploads_userId_idx" ON "custom_uploads"("userId");
...
-- AddForeignKey
ALTER TABLE "custom_uploads" ADD CONSTRAINT "custom_uploads_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
