...
function LoginForm() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      const message =
        e instanceof ApiRequestError ? e.message : 'Unable to sign in. Please try again.';
      toast.error(message);
      setSubmitting(false);
    }
  };
  ...
  const onGoogle = () => {
    window.location.href = PUBLIC_API_URL + '/api/v1/auth/google';
  };

  return (
    <AuthCard title="Sign in" subtitle="Welcome back to HashTag Creations">
